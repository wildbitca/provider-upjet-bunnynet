...
This provider exposes 23 managed resources from the [Bunny.net Terraform Provider v0.14.0](https://registry.terraform.io/providers/BunnyWay/bunnynet/0.14.0/docs), organized in 5 API groups:
