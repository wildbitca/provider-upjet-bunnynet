...
func main() {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-upjet-bunnynet-stream",
		Cache: cache.Options{
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_stream(mgr, clusterOpts), "Cannot setup cluster-scoped UpjetBunnynet controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_stream(mgr, namespacedOpts), "Cannot setup namespaced UpjetBunnynet controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_stream(mgr, clusterOpts), "Cannot setup cluster-scoped UpjetBunnynet controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_stream(mgr, namespacedOpts), "Cannot setup namespaced UpjetBunnynet controllers")
	}
