...
import (
	...
	clusterv1beta1 "github.com/wildbitca/provider-upjet-bunnynet/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/wildbitca/provider-upjet-bunnynet/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal bunnynet credentials as JSON"

	// Bunny.net provider config keys
	// https://registry.terraform.io/providers/BunnyWay/bunnynet/latest/docs
	keyAPIKey = "api_key"
)

// credentialKeys is the list of Bunny.net provider config keys to copy from credentials.
var credentialKeys = []string{keyAPIKey}
